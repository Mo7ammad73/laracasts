                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/page_links" class="text-gray-300 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Home</a>
                            ...
                            <a href="/page_links/contact.php" class="bg-gray-900 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
