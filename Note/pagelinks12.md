...
کدهای ما از سه بخش nav -header و main  تشکیل شده که در قسمت nav  منوهای سایت و در قسمت  header قسمت هدر سایت و در main محتوای سایت را قرار میدهیم .در قسمت زیر بخشی از کد بالا که میتوان منوهای بالای سایت را عوض کرد را میبینیم و میتوانیم منو ها را اضافه حذف و تغییر دهیم
